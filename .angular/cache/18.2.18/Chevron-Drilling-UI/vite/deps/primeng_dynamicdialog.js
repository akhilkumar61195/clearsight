...
function DynamicDialogComponent_div_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵproperty("ngClass", ɵɵpureFunction4(18, _c5, ctx_r1.config.rtl, ctx_r1.config.resizable, ctx_r1.config.draggable, ctx_r1.maximized))("ngStyle", ctx_r1.config.style)("@animation", ɵɵpureFunction1(26, _c7, ɵɵpureFunction2(23, _c6, ctx_r1.transformOptions, ctx_r1.config.transitionOptions || "150ms cubic-bezier(0, 0, 0.2, 1)")))("pFocusTrapDisabled", ctx_r1.config.focusTrap === false);
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    template: function DynamicDialogComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        ɵɵtemplate(2, DynamicDialogComponent_div_2_Template, 9, 28, "div", 6);
        ɵɵelementEnd();
      }
      if (rf & 2) {
