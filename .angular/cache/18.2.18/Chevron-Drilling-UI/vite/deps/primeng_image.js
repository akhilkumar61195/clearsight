...
var Image = class _Image {
  ...
  static ɵfac = function Image_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _Image)(ɵɵdirectiveInject(DOCUMENT), ɵɵdirectiveInject(PrimeNGConfig), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(ElementRef));
  };
  static ɵcmp = ɵɵdefineComponent({
    type: _Image,
    selectors: [["p-image"]],
