...
@Component({
  selector: 'app-custom-rig-header-lable-completion',
  template: `
    <div class="customHeaderLabel">
      <span class="header-span" >Supplier</span>
      <span class="header-span">MM# / MMR#</span>
...
export class RigHeaderLableCompletion implements IHeaderGroupAngularComp {
